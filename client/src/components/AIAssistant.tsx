    ...
    tasks: [
      {
        ...
        desc: "5 compelling title options",
      },
      {
        id: "outline",
        icon: List,
        label: "Generate Outline",
        desc: "Structured post outline",
      },
      {
        id: "draft",
        icon: FileText,
        label: "Write Draft",
        desc: "Full post from outline/topic",
      },
      {
        id: "continue",
        icon: ArrowDown,
      ...
      },
      {
        ...
        icon: MessageSquare,
        label: "Generate FAQ",
        desc: "Relevant Q&A section",
      },
      {
        id: "toc",
        icon: List,
        label: "Table of Contents",
        desc: "From headings in post",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        icon: Tag,
        label: "Generate Tags",
        desc: "Relevant post tags",
      },
      {
        id: "categories",
        icon: Hash,
        label: "Categories",
        desc: "Suggested categories",
      },
      {
        id: "slug",
        icon: Globe,
        label: "Generate Slug",
        desc: "URL-friendly slug",
      },
      {
        id: "excerpt",
        icon: AlignLeft,
        label: "Write Excerpt",
        desc: "Compelling 1-2 sentence excerpt",
      },
    ],
  },
  {
    ...
    tasks: [
      {
        ...
        icon: AlignLeft,
        label: "Summarize",
        desc: "3-5 sentence summary",
      },
      {
        id: "social",
        icon: MessageSquare,
        label: "Social Posts",
        desc: "Twitter, LinkedIn, Mastodon",
      },
      {
        id: "callout",
        icon: Sparkles,
        label: "Add Callout",
        desc: "Relevant callout box",
      },
      {
        id: "internal-links",
        icon: Globe,
        label: "Internal Links",
        desc: "Link opportunity suggestions",
      },
    ],
  },
];
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b border-border">
        ...
        <Badge
          variant="outline"
          className="ml-auto text-[10px] text-forge-violet border-forge-violet/30"
        >
          Server-side
        </Badge>
      </div>
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {canApplyToFrontMatter && (
                  <Button
                    size="sm"
                    className="h-7 text-xs gap-1"
                    onClick={handleApplyFrontMatter}
                  >
