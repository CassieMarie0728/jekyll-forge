/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 93cb1fe27a4780a7d6b6640b9e673583)
// Runtime types generated with workerd@1.20260918.1 2026-09-19 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	ASSETS: Fetcher;
	APP_URL: "https://jekyll-forge.c728.workers.dev";
	GITHUB_CLIENT_ID: "Ov23linleILZILcgsHN7";
	OWNER_GITHUB_ID: "66750031";
	JWT_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "GITHUB_CLIENT_ID" | "OWNER_GITHUB_ID" | "JWT_SECRET">> {}
}
