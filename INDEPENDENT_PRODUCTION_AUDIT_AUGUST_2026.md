...
|---|---:|---|
| Web automated suite | **22 files passed; 140 tests passed; 7 skipped** | Final `pnpm test` after supported-platform social analytics synchronization coverage |
