...
|---|---:|---|
| Web automated suite | **20 files passed; 137 tests passed; 7 skipped** | Final `pnpm test` after GitHub upstream-error redaction regression coverage |
