...
|---|---:|---|
| Web automated suite | **25 files passed; 149 tests passed; 7 skipped** | Final `pnpm test` after scheduled post-to-site ownership coverage |
