...
export default function NotificationsScreen({ navigation }: any) {
  ...
  > = {
    publishSuccess: {
      ...
      description: "When a post is published successfully",
    },
    scheduledReminders: {
      label: "Scheduled Reminders",
      description: "Reminders for upcoming scheduled posts",
    },
    analyticsUpdates: {
      label: "Analytics Updates",
      description: "When posts reach engagement milestones",
    },
    socialMediaAlerts: {
      label: "Social Media Alerts",
      description: "Alerts about social media account issues",
    },
    abTestResults: {
      label: "A/B Test Results",
      description: "When A/B tests complete with a winner",
    },
    systemUpdates: {
    ...
    <SafeAreaView style={styles.container}>
      ...
      {activeTab === "notifications" ? (
        ...
        <ScrollView style={styles.settingsContent}>
          ...
          {preferences &&
            (
              Object.keys(preferenceLabels) as Array<
                keyof NotificationPreferences
              >
            ).map(key => (
