...
function ToastItem({
  ...
  const getColors = () => {
    switch (toast.type) {
      case "success":
        return { bg: "#064e3b", border: "#10b981", icon: "#34d399" };
      case "error":
        return { bg: "#450a0a", border: "#ef4444", icon: "#f87171" };
      case "warning":
        return { bg: "#451a03", border: "#f59e0b", icon: "#fbbf24" };
      case "info":
        return { bg: "#0c1a3d", border: "#3b82f6", icon: "#60a5fa" };
    }
  };
